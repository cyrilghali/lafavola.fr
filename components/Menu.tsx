...
export default function Menu() {
  return (
    <div className="relative bg-[#252525] py-16">
      <div className="absolute inset-x-0 top-0 hidden h-1/2 bg-[#252525] lg:block" aria-hidden="true" />
      <div className="mx-auto max-w-7xl bg-yellow-400 lg:bg-transparent lg:px-8">
        <div className="lg:grid lg:grid-cols-12">
          <div className="relative z-10 lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:bg-transparent lg:py-16">
           <div className="absolute inset-x-0 h-1/2 bg-yellow-400 lg:hidden" aria-hidden="true" />
          ...
          <div className="relative bg-yellow-400 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            ...
            <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              <h2 className="text-3xl font-bold tracking-tight text-[#252525]" id="join-heading">
