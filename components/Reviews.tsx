      ...
      <div>
        ...
        <div className="-my-10">
          {reviews.map((review, reviewIdx) => (
            <div key={review.id} className="flex space-x-4 text-sm text-white-500">
              <div className="flex-none py-10">
                <img src={review.avatarSrc} alt="" className="h-10 w-10 rounded-full bg-white-900" />
              </div>
              <div className={classNames(reviewIdx === 0 ? '' : 'border-t border-gray-700', 'flex-1 py-10')}>
                <h3 className="font-medium text-white-900">{review.author}</h3>
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        review.rating > rating ? 'text-yellow-400' : 'text-white-300',
                ...
                <div
                  className=" text-white-500 mt-4 max-w-none "
