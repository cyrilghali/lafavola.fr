      ...
      <div>
        ...
        <div className="-my-10">
          {reviews.map((review, reviewIdx) => (
            <div key={review.id} className="flex space-x-4 text-sm text-white/50">
              ...
              <div className={classNames(reviewIdx === 0 ? '' : 'border-t border-gray-700', 'flex-1 py-10')}>
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        review.rating > rating ? 'text-yellow-400' : 'text-white/30',
                ...
                <div
                  className=" text-white/50 mt-4 max-w-none "
